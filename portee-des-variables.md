...
Les variables extérieures peuvent être utilisée de la même manière que les variables locales.
...
Mais cette *closure* n'est pas éternelle est disparaît naturellement quand elle est elle-même déréférencée, c'est à dire quand la fonction qui emprisonne ces valeurs disparaît.
